  ...
  <div id="content" class="tab-content active" data-tabid="tab1"><div id="login-wrapper">
    <div id="login-form">
      <div id="login-form-form">
        ...
        <div class="b-content">
          <span class="b-text b-text_lang_en">Site control.sharov.su just created.</span>
          <span class="b-text b-text_lang_ru">Сайт control.sharov.su только что создан.</span>
          <br/>
